...
const bodySchema = z.object({
  ...
  audience: z.array(z.string().min(1).max(60)).max(10),
  problem_solved: z.string().max(1000),
  difficulty: z.enum(["beginner", "intermediate", "advanced"]),
  time_to_implement: z.string().max(60),
  tools_used: z.array(z.string().min(1).max(60)).max(20),
