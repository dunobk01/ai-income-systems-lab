...
const FAQS = [
  {
    ...
    a: "The AI Income Operating System PDF unlocks instantly on the next screen and arrives as an email attachment. You can also create a free account for Module 1 and the sample lessons.",
  },
  {
    q: "Is it really free?",
          ...
          {state === "done" ? (
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground max-w-xl">
                 The PDF is attached to the email on its way to your inbox. Create your free account to unlock Module 1 and the sample
                lessons.
              </p>
            ...
            <div className="grid gap-6 md:grid-cols-[1fr_auto] md:items-center">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full glass px-3 py-1 text-xs text-muted-foreground">
                   <Mail className="h-3.5 w-3.5 text-[color:var(--brand-2)]" /> Instant email attachment + download
                </div>
                <h2 className="mt-3 text-2xl sm:text-3xl font-bold tracking-tight">Send me the guide</h2>
                <p className="mt-2 text-sm text-muted-foreground max-w-xl">
                   Enter your email and we'll attach the PDF to your welcome email. It also unlocks here immediately.
                </p>
              </div>
